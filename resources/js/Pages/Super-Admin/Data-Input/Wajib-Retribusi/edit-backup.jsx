...
const Edit = ({
  ...
  const { data, setData, errors, processing, clearErrors, progress, put } =
    useForm(initialData);
  ...
  const handleSubmit = (e) => {
    ...
    put(route("super-admin.wajib-retribusi.update", { id: retribusi.id }), {
      forceFormData: true,
      onSuccess: () => {
        setData(initialData);
      },
        ...
        >
          ...
          <div className="col-span-2 flex flex-col gap-1.5 text-sm">
            ...
            <input
              ...
              value={data.bulan}
              onChange={(e) =>
                setData("bulan", e.target.value.replace(/\D/g, ""))
              }
            />
            {errors.bulan && (
          ...
          <FormInput className="col-span-2 md:col-span-1">
            ...
            <Input
              ...
              accept="image/*"
              onChange={
                (e) => setData("fotoBangunan", e.target.files[0])

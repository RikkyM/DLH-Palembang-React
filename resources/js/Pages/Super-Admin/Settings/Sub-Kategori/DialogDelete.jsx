...
const DialogDelete = ({ isOpen, onClose, subkategori }) => {
  const { processing, delete: destroy } = useForm();

  const handleDelete = (e) => {
    e.preventDefault();

    if (!subkategori?.kodeSubKategori) return;

    destroy(
      route("super-admin.sub-kategori.destroy", subkategori.kodeSubKategori),
      {
        onSuccess: () => {
          onClose();
        },
        ...
        <div className="px-5 pb-5">
          ...
          <div className="mb-6 text-center">
            ...
            <p className="mb-4 text-sm text-gray-600">
              Anda akan menghapus Sub Kategori berikut ini:
            </p>
              ...
              <div className="space-y-2">
                <div>
                  ...
                  <span className="text-gray-900">
                    {subkategori?.kategori.namaKategori}
                  </span>
                </div>
                <div>
                  <span className="font-medium text-gray-700">
                ...
                <div>
                  ...
                  <span className="text-gray-900">
                    {(() => {
                      try {
                        const parsed = JSON.parse(subkategori?.perhitungan);
                        return parsed.rumus || "-";
                      } catch {
                        return subkategori?.perhitungan || "-";
                      }
                    })()}
                  </span>
                </div>

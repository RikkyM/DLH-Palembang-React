...
const Index = ({ datas, filters }) => {
  ...
  useEffect(() => {
    ...
    const timeoutId = setTimeout(() => {
      ...
      router.get(route("super-admin.badan-usaha.index"), params, {
        preserveState: true,
        replace: true,
        only: ["datas"],
            ...
            <table className="min-w-full divide-y divide-gray-300 p-3">
              <thead>
                <tr className="text-white *:bg-[#F1B174] *:p-2 *:text-sm *:font-medium">
                  ...
                  <th className="text-left">Nama Badan Usaha</th>

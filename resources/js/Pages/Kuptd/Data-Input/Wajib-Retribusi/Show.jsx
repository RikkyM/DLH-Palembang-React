...
const Show = ({
  ...
  const initialData = {
    ...
    fotoBangunan: retribusi.url_image[0] || null,
    fotoBerkas: retribusi.url_file[0] || null,
    variabelValues: { bulan: 1 },
    tarifPerbulan: retribusi.tarifPerbulan || null,
    tarifRetribusi: 0,
    jenisTarif: "tarif",
  };
    ...
    <Layout title="FORM OBJEK RETRIBUSI">
      <section className="p-3">
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          ...
          <div className="pointer-events-none relative z-0 col-span-2 flex flex-col gap-1.5 text-sm">
            <MapPicker
          ...
          {/* <div className="col-span-2 flex flex-col gap-1.5 text-sm md:col-span-1">
            ...
            {data.fotoBangunan && (
              <span className="text-xs text-green-600">
                File dipilih: {data.fotoBangunan}
              </span>
            )}
          </div>
          <div className="col-span-2 flex flex-col gap-1.5 text-sm md:col-span-1">

...
const WajibRetribusiEdit = ({
  ...
  const roleConfig = {
    ROLE_SUPERADMIN: {
      ...
      ditolak: "super-admin.wajib-retribusi.ditolak",
      submitRoute: "super-admin.wajib-retribusi.update",
    },
    ROLE_PENDAFTAR: {
      diterima: "pendaftar.wajib-retribusi.diterima",
      ditolak: "pendaftar.wajib-retribusi.ditolak",
  ...
  const initialData = {
    ...
    tarifRetribusi: 0,
    jenisTarif: retribusi.jenisTarif || "tarif",
    tanggalSkrd:
  ...
  return (
    <section className="p-3">
      <Link
        href={route(
          status === "diterima"
            ? currentConfig.diterima
            : currentConfig.ditolak,
        )}
      ...
      >
        ...
        <div className="col-span-2 grid gap-5 lg:grid-cols-3">
          <FormInput className="col-span-2 flex flex-col gap-1.5 text-sm md:col-span-1">
            ...
            {!data.fotoBangunan && retribusi.image && (
              <span className="flex w-max flex-col gap-0.5 text-xs">
                <p>Foto Bangunan: </p>
                <a
                  target="_blank"
                  className="text-blue-500 hover:underline"
                  href={route("private.file", {
                    type: "image",
          ...
          <FormInput className="col-span-2 flex flex-col gap-1.5 text-sm md:col-span-1">
            ...
            {!data.fotoBerkas && retribusi.file && (
              <span className="flex w-max flex-col gap-0.5 text-xs">
                <p>Foto Bangunan: </p>
                <a
                  target="_blank"

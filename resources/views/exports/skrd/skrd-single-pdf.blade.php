        ...
        <tbody>
            <tr style="font-size: 18px;">
                ...
                <td colspan="2"
                    ...
                    {{ $data->alamatObjekRetribusi }}<br />
                    <span>Palembang</span><br />
                    <span style="display: inline-block; padding-top: 10px;">kelurahan
                        {{ $data->kelurahanObjekRetribusi }}</span><br />
                    <span>kecamatan {{ $data->kecamatanObjekRetribusi }}</span>
                </td>
            </tr>
            <tr style="font-size: 18px; ">
            ...
            <tr style="font-size: 18px; ">
                ...
                <td style=" text-align: center; padding: 4px; width: 50%;" colspan="2">
                    {{ $data->namaSubKategori }}</td>
            </tr>
            <tr style="font-size: 18px;">
                <td colspan="2" style="witdth: 50%; border: 1px solid black; padding: 4px; padding-left: 20px; ">
                    Tarif Retribusi yang harus dibayar/bulan: <br /> Rp
                    {{ number_format($data->tagihanPerBulanSkrd, 2, ',', '.') }} <br />
                    <span style="text-transform: uppercase;">{{ terbilang($data->tagihanPerBulanSkrd) }} rupiah</span>
                </td>
                <td colspan="2" style="witdth: 50%; border: 1px solid black; padding: 4px; padding-left: 20px;">
                    Tarif Retribusi yang harus dibayar/tahun:<br />
                    Rp {{ number_format($data->tagihanPerTahunSkrd, 0, ',', '.') }} <br />
                    <span style="text-transform: uppercase;">{{ terbilang($data->tagihanPerTahunSkrd) }} rupiah</span>
                </td>
            </tr>
            {{-- <tr style="font-size: 18px;">

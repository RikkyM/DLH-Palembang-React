...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('wajib_retribusi', function (Blueprint $table) {
            ...
            $table->string('kodeKelurahan')->nullable();
            $table->string('kodeKecamatan');
            $table->foreignId('uptdId')->constrained('uptd')->onUpdate('cascade')->onDelete('cascade');
            $table->foreignId('pemilikId')->nullable()->constrained('pemilik')->onUpdate('cascade')->onDelete('cascade');
            $table->foreignId('petugasPendaftarId')->nullable()->constrained('users')->onUpdate('cascade');
            ...
            $table->string('statusTempat')->nullable();
            ...
            $table->integer('jumlahBangunan')->nullable();
